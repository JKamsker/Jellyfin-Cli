...
using System;
namespace Jellyfin.Cli.Api.Generated.Audio.Item.Universal
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task GetAsync(Action<RequestConfiguration<global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task GetAsync(Action<RequestConfiguration<global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task HeadAsync(Action<RequestConfiguration<global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderHeadQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task HeadAsync(Action<RequestConfiguration<global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderHeadQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderHeadQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderHeadQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets an audio stream.
        /// </summary>
...
#nullable restore
            ...
            [Obsolete("This property is deprecated, use TranscodingProtocolAsMediaStreamProtocol instead")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// <summary>Optional. The transcoding protocol.</summary>
            [QueryParameter("transcodingProtocol")]
            public global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.MediaStreamProtocol? TranscodingProtocolAsMediaStreamProtocol { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class UniversalRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Gets an audio stream.
...
#nullable restore
        ...
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class UniversalRequestBuilderHeadRequestConfiguration : RequestConfiguration<global::Jellyfin.Cli.Api.Generated.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderHeadQueryParameters>
        {
        }
    }
}
