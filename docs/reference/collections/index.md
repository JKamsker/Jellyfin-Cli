...
[README](../README.md) › `collections`

Create collections and add or remove items

## Subcommands

- [add](#command-collections-add) — Add items to a collection
- [create](#command-collections-create) — Create a collection
- [remove](#command-collections-remove) — Remove items from a collection

## Examples

- `jf collections create --name demo`
...
- `jf collections add 12345 --items 12345`
...
- `jf collections remove 12345 --items 12345`
