...
[README](../README.md) › `library`

Scan libraries and manage virtual folders [[admin]]

## Subcommands

- [folders](#command-library-folders) — List, create, rename, or remove virtual folders [[admin]]
  - [add](#command-library-folders-add) — Create a virtual folder
  - [list](#command-library-folders-list) — List virtual folders
  - [remove](#command-library-folders-remove) — Remove a virtual folder
  - [rename](#command-library-folders-rename) — Rename a virtual folder
- [media](#command-library-media) — Show media folders
- [options](#command-library-options) — Show or update library options for one virtual folder
- [paths](#command-library-paths) — Manage media paths inside a virtual folder [[admin]]
  - [add](#command-library-paths-add) — Add a media path to a library
  - [remove](#command-library-paths-remove) — Remove a media path from a library
  - [update](#command-library-paths-update) — Update a media path entry
- [scan](#command-library-scan) — Start a full library refresh
