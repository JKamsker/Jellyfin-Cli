...
- [create](#command-users-create) — Create a user
- [delete](#command-users-delete) — Delete a user
- [get](#command-users-get) — Show one user
- [list](#command-users-list) — List users
- [password](#command-users-password) — Change a user's password
- [policy](#command-users-policy) — Update a user's policy
- [update](#command-users-update) — Update a user

## Examples

- `jf users list --server http://localhost:8096`
...
- `jf users create demo --password secret`
...
- `jf users delete 12345 --server http://localhost:8096`
...
- `jf users password 12345 --new-password secret`
...
- `jf users update 12345 --name demo`
