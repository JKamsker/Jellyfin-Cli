...
[README](../README.md) › `syncplay`

Manage SyncPlay groups

## Subcommands

- [create](#command-syncplay-create) — Create a new group
- [join](#command-syncplay-join) — Join a group
- [leave](#command-syncplay-leave) — Leave current group
- [list](#command-syncplay-list) — List SyncPlay groups

## Examples

- `jf syncplay list --server http://localhost:8096`
...
- `jf syncplay create --name movie-night`
...
- `jf syncplay join --group-id 00000000-0000-0000-0000-000000000001`
...
- `jf syncplay leave --server http://localhost:8096`
