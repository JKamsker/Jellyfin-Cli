...
- `jf sessions list --controllable-by 00000000-0000-0000-0000-000000000001`
...
- `jf sessions command 12345 command --server http://localhost:8096`
...
- `jf sessions message 12345 text --header X-Test: 1`
...
- `jf sessions play 12345 12345 --play-command command`
...
- `jf sessions state action 12345 --position 1`
