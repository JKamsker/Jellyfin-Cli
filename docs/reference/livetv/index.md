...
[README](../README.md) › `livetv`

Channels, guide, recordings, timers, tuners, listings

## Subcommands

- [channels](#command-livetv-channels) — List channels
- [guide](#command-livetv-guide) — Show program guide
- [info](#command-livetv-info) — Show Live TV info
- [recordings](#command-livetv-recordings) — List recordings
- [timers](#command-livetv-timers) — List timers

## Examples

- `jf livetv info --server http://localhost:8096`
...
- `jf livetv channels --server http://localhost:8096`
...
- `jf livetv guide --server http://localhost:8096`
...
- `jf livetv recordings --server http://localhost:8096`
...
- `jf livetv timers --server http://localhost:8096`
