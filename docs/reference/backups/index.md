...
- [create](#command-backups-create) — Create a new backup
- [inspect](#command-backups-inspect) — Inspect a backup archive manifest
- [list](#command-backups-list) — List backup archives
- [restore](#command-backups-restore) — Restore an archive and restart the server
